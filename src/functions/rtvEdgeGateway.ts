  ...
  if (path === "gifts" || body.action === "gifts") {
    try {
      ...
      return Response.json({
        success: true,
        gifts: [
          { id: "g1", name: "Rose", emoji: "🌹", price_usd: 0.01, stars: 1, category: "basic" },
          { id: "g2", name: "Heart", emoji: "💖", price_usd: 0.05, stars: 5, category: "basic" },
          { id: "g3", name: "Kiss", emoji: "💋", price_usd: 0.10, stars: 10, category: "basic" },
          { id: "g4", name: "Cocktail", emoji: "🍹", price_usd: 0.20, stars: 25, category: "premium" },
          { id: "g5", name: "Diamond", emoji: "💎", price_usd: 0.50, stars: 50, category: "premium" },
          { id: "g6", name: "Sports Car", emoji: "🏎️", price_usd: 1.00, stars: 100, category: "premium" },
