    ...
    <div className="min-h-screen flex flex-col" style={{ background: "#0D0D0D", color: "white", fontFamily: "Inter, sans-serif", maxWidth: 480, margin: "0 auto" }}>
      ...
      <div className="flex items-center justify-between px-4 py-3" style={{ background: "#0D0D0D", borderBottom: "1px solid #1a1a1a" }}>
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg flex items-center justify-center font-black text-black text-sm" style={{ background: "linear-gradient(135deg, #6C5CE7, #A29BFE)" }}>R</div>
